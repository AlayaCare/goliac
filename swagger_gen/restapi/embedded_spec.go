  ...
  "definitions": {
    ...
    "repositoryDetails": {
      ...
      "properties": {
        ...
        "githubPages": {
          "$ref": "#/definitions/repositoryDetailsGithubPages"
        },
        "name": {
          "type": "string",
          "x-isnullable": false
    ...
    "repositoryDetailsGithubPages": {
      ...
      "properties": {
        ...
        "customDomain": {
          "description": "GitHub Pages custom domain (cname); mirrors spec.github_pages.custom_domain when declared locally.",
          "type": "string"
        },
        "enabled": {
          "type": "boolean",
        ...
        "enforceHttps": {
          "description": "Whether HTTPS is enforced for the Pages site (GitHub https_enforced); set with a custom domain in spec.",
          "type": "boolean"
        },
        "htmlUrl": {
          "type": "string"
