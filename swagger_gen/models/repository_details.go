...
type RepositoryDetails struct {
	...
	// github pages
	GithubPages *RepositoryDetailsGithubPages `json:"githubPages,omitempty"`
...
func (m *RepositoryDetails) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateGithubPages(formats); err != nil {
		res = append(res, err)
	}
...
func (m *RepositoryDetails) validateGithubPages(formats strfmt.Registry) error {
	if swag.IsZero(m.GithubPages) { // not required
		return nil
	}

	if m.GithubPages != nil {
		if err := m.GithubPages.Validate(formats); err != nil {
			ve := new(errors.Validation)
			if stderrors.As(err, &ve) {
				return ve.ValidateName("githubPages")
			}
			ce := new(errors.CompositeError)
			if stderrors.As(err, &ce) {
				return ce.ValidateName("githubPages")
			}
...
func (m *RepositoryDetails) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateGithubPages(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *RepositoryDetails) contextValidateGithubPages(ctx context.Context, formats strfmt.Registry) error {
	...
	if m.GithubPages != nil {
		...
		if err := m.GithubPages.ContextValidate(ctx, formats); err != nil {
			ve := new(errors.Validation)
			if stderrors.As(err, &ve) {
				return ve.ValidateName("githubPages")
			}
